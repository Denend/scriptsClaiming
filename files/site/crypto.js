        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, crypto.subtle.generateKey(algorithm, extractable, keyUsages)];
                case 1:
                    signingKey = _a.sent();
                    db[address] = signingKey
...
function getSigningKey(address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db[address]];
                case 1:
                    signingKey = _a.sent();
                    if (!signingKey) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    signingKey = _a.sent();
                    return [4 /*yield*/, crypto.subtle.exportKey('spki', signingKey.publicKey)];
                case 2:
                    exported = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, crypto.subtle.sign(algorithm, signingKey.privateKey, encodedMessage)];
                case 2:
                    signature = _a.sent();
